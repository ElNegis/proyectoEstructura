...
public class frmPrincipal extends javax.swing.JFrame  implements Runnable{
    ...
    private void initComponents() {
        ...
        tbn_escritorio.setBackground(new java.awt.Color(0, 102, 49));

        kGradientPanel1.setkEndColor(new java.awt.Color(0, 153, 112));
        kGradientPanel1.setkStartColor(new java.awt.Color(0, 197, 204));
